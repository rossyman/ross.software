  ...
  return (
    <section style={ANIMATION_ORDER}>
      ...
      <p className={styles.contactMe}>
        <StylizedText>Let&apos;s hang out</StylizedText>; Contact me on <a href={linkedinUrl}>LinkedIn</a> - 
        If you&apos;re in Glasgow, let&apos;s grab a coffee.
      </p>
      <p>
        <StylizedText>Interested in my work? </StylizedText> Find me on <a href={githubUrl}>GitHub</a>.
      </p>
    </section>
  )
}
